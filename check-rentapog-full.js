...
const result = await client.query("SELECT id, email, name, referral_code, is_active, is_sub_admin FROM users WHERE referral_code = 'rentapog'");
console.log("RentAPog User Account:");
