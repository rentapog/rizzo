  ...
  app.post("/api/affiliates/home-signup", async (req, res) => {
    try {
      ...
      try {
        ...
        // For test site, just use main domain (packages subdomain not set up yet)
        const packagesLink = referrerCode 
          ? `https://${siteBranding.domain}/?aff=${referrerCode}`
          : `https://${siteBranding.domain}`;
          ...
          await sendEmail({
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p style="font-size: 16px;">These leads are now in your funnel! When any of them purchase a package, <strong>you'll earn the commission</strong>.</p>
